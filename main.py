...
class Application():
    def __init__(self,master,*args,**kwargs):
        ...
        #components
        self.heading=Label(self.left,text="JRV Mercados",font=('arial 40 bold'),fg='white',bg='black')
        self.heading.place(x=0,y=0)

        self.date_l=Label(self.right,text="Data de Hoje: "+str(date),font=('arial 16 bold'),bg='gray',fg='white')
        self.date_l.place(x=0,y=0)

        #table invoice=======================================================
        self.tproduct=Label(self.right,text="Produtos",font=('arial 18 bold'),bg='gray',fg='white')
        self.tproduct.place(x=0,y=60)

        self.tquantity = Label(self.right, text="Quantidade", font=('arial 18 bold'), bg='gray', fg='white')
        self.tquantity.place(x=300, y=60)

        self.tamount = Label(self.right, text="Preço", font=('arial 18 bold'), bg='gray', fg='white')
        self.tamount.place(x=500, y=60)

        #enter stuff
        self.enterid=Label(self.left,text="Código do Produto",font=('arial 18 bold'),fg='white',bg='black')
        ...
        #button
        self.search_btn=Button(self.left,text="Pesquisa",width=22,height=2,bg='orange',command=self.ajax)
    ...
    def ajax(self,*args,**kwargs):
        ...
        if self.pc:
          ...
          self.productname.configure(text="Nome do Produto: " +str(self.get_name),fg='white',bg='black')
          self.pprice.configure(text="Preço:RS. "+str(self.get_price),fg='white',bg='black')
        ...
        #discount
          self.discount_l = Label(self.left, text="Enter Desconto", font=('arial 18 bold'),fg='white',bg='black')
